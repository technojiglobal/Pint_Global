      ...
      <div className="relative z-10 flex items-center min-h-[40vh] md:min-h-[55vh] lg:min-h-[65vh]">
        <div className="max-w-3xl">
          ...
          <p className="text-white mt-6 text-base sm:text-lg md:text-xl leading-relaxed">
            We offer premium Indian products carefully sourced from trusted, 
            certified suppliers. Every shipment is processed with strict 
            quality control and delivered with full international compliance.
          </p>
